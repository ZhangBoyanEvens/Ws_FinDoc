...
<p align="center">
  <b>Language · 语言</b> — 展开下面一节阅读；收起另一节即可切换（不要同时展开两节）。<br>
  Expand <b>one</b> section below; collapse the other to switch.
</p>
...
- **集成**：第三方 Codrops Demo 经 `useLayoutEffect` 挂载/销毁，并恢复 `document` class 与全局 GSAP 引用。
